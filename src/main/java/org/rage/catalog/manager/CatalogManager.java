...
public interface CatalogManager
{
    ...
    *
    */
   List <Catalog> getCatalogList (String catalogName) throws ValidationCatalogException, DataCatalogException;
    ...
    */
   Catalog getCatalogById (String catalogName, Integer id) throws ValidationCatalogException, DataCatalogException;
}
